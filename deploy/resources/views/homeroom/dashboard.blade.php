...
<div class="space-y-6">
    ...
    <div class="flex flex-wrap justify-between items-center gap-3">
        <h3 class="font-bold text-slate-800 dark:text-slate-100 text-base">Daftar Nilai & Presensi Rapor Siswa</h3>
        ...
        <div class="overflow-x-auto"><table class="w-full">
            ...
            <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                ...
                <tr class="hover:bg-slate-50 dark:hover:bg-slate-800/50">
                    ...
                    <td class="table-cell text-center text-xs text-slate-500 dark:text-slate-400">{{ $rem && isset($rem->sick) ? $rem->sick : 0 }} / {{ $rem && isset($rem->permission) ? $rem->permission : 0 }} / {{ $rem && isset($rem->unexcused) ? $rem->unexcused : 0 }}</td>
    ...
    @else
    <div class="card text-center py-12 text-slate-500 dark:text-slate-400">Anda belum ditugaskan sebagai wali kelas aktif saat ini.</div>
    @endif
</div>
@endsection