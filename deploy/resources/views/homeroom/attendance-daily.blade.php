                ...
                <table class="w-full min-w-[700px]">
                    ...
                    <tbody class="divide-y divide-slate-200 dark:divide-slate-800">
                        ...
                        <tr class="hover:bg-slate-50/80 dark:hover:bg-slate-800/50 transition">
                            <td class="table-cell text-center font-mono text-xs text-slate-400 dark:text-slate-500">{{ $index + 1 }}</td>
                            <td class="table-cell font-semibold text-slate-800 dark:text-slate-200 py-3">
                                {{ $s->name }}<br><span class="text-xs text-slate-400 dark:text-slate-500 font-mono">{{ $s->nis }}</span>
                            </td>
