...
<style type="text/tailwindcss">
  ...
  .btn-secondary { @apply inline-flex items-center justify-center gap-2 px-4 py-2 bg-slate-100 text-slate-700 rounded-xl hover:bg-slate-200 transition text-sm font-medium cursor-pointer border border-slate-200; }
  ...
  .input { @apply w-full border border-slate-300 rounded-xl px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white placeholder-slate-400 text-slate-800; }
  .select { @apply w-full border border-slate-300 rounded-xl px-3.5 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 bg-white text-slate-800; }
  .label { @apply block text-xs font-semibold text-slate-600 mb-1.5 uppercase tracking-wider; }
  .table-head { @apply bg-slate-50 text-xs font-semibold text-slate-600 uppercase tracking-wider px-3.5 py-3 text-left border-b border-slate-200 whitespace-nowrap; }
  .table-cell { @apply px-3.5 py-2.5 text-sm text-slate-700 border-b border-slate-200; }
