...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="card h-fit">
        <h3 class="font-bold text-slate-800 mb-4 text-base">+ Tambah Mapel</h3>
        ...
        <div class="overflow-x-auto"><table class="w-full">
            ...
            <tbody class="divide-y divide-slate-100">
                ...
                <tr class="hover:bg-slate-50">
                    <td class="table-cell font-mono font-bold text-blue-600">{{ $subject->code }}</td>
                    <td class="table-cell font-medium text-slate-800">{{ $subject->name }}</td>
                    <td class="table-cell text-center font-semibold text-slate-700">{{ $subject->kkm }}</td>
